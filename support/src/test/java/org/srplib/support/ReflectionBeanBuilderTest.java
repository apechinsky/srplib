...
//"CustomMessage(parameter). Instance creation error [class: org.srplib.support.ReflectionBeanBuilderTest$TestBean, parameters: [class java.lang.String] values: [ConstructorExceptionMessage.]]. ConstructorExceptionMessage."
//"CustomMessage(parameter). Instance creation error [class: org.srplib.support.ReflectionBeanBuilderTest$TestBean, parameters: [class java.lang.String] values: [ConstructorExceptionMessage.]]."
    ...
    public void testConstructorException() throws Exception {
        try {
            ...
            String expectedErrorMessage = "CustomMessage(parameter). Instance creation error " +
                "[class: org.srplib.support.ReflectionBeanBuilderTest$TestBean, parameters: [class java.lang.String] " +
                "values: [ConstructorExceptionMessage.]].";
